    ...
    <section className="mb-20 mt-28">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div
          ...
          <ul className="text-gray-600 text-base leading-relaxed">
            <li>وضع الخطط الفنية والتقنية لتحقيق الأهداف الاستراتيجية للمؤسسة.</li>
        ...
        <div
          ...
          <ul className="text-gray-600 text-base leading-relaxed">
            <li>إعداد المحتوى التدريبي للفرق الفنية والإدارية لضمان إلمامهم بالتقنيات الحديثة.</li>
            <li>توفير ورش العمل والدورات التدريبية لتحسين المهارات الفنية لدى الأفراد.</li>
            <li>متابعة الأداء الفني وتقديم الدعم المستمر للتطوير الشخصي والتقني.</li>
          </ul>
        </div>
        ...
        <div
          ...
          <ul className="text-gray-600 text-base leading-relaxed">
            <li>التعاون مع الشركات التقنية، الجامعات، والمختصين لتطوير الحلول الفنية.</li>
            <li>بناء شراكات مع الجهات الحكومية والقطاع الخاص لدعم المبادرات التقنية.</li>
